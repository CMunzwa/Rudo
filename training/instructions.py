...
instructions = (
    ...
    "*Another Example*\n"
    "user:<sends an image of a Condom>\n"
    "backend will process this image and will tell you it's a condom.\n"
